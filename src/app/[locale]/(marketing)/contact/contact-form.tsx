...
export function ContactForm() {
  ...
  if (succeeded) {
    return (
      <div
        role="status"
        className="flex flex-col items-start gap-3 rounded-md bg-card p-8 shadow-card-md"
      >
  ...
  return (
    <form
      action={action}
      className="flex flex-col gap-5 rounded-md bg-card p-6 shadow-card-md sm:p-8"
    >
