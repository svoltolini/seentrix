                ...
                {imagePreview ? (
                  <div className="relative w-fit">
                    ...
                    <button
                      ...
                      className="absolute -right-2 -top-2 flex size-6 items-center justify-center rounded-full border border-border bg-card text-muted-foreground transition-colors hover:bg-destructive hover:text-white"
                    >
