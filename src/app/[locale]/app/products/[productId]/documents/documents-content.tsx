  ...
  if (editingType) {
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Actions */}
        {doc && (
          <div className="flex flex-wrap items-center gap-3 rounded-lg border border-border bg-card shadow-card-sm px-5 py-4">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {DOCUMENT_TYPES.map((config) => {
          ...
          return (
            ...
            >
              <div className="flex h-full flex-col overflow-hidden rounded-lg border border-border bg-card shadow-card-sm transition-shadow hover:shadow-card-md">
