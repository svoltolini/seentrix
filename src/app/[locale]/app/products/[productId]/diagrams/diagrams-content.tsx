  ...
  return (
    <div className="space-y-10">
      ...
      <section className="space-y-4">
        ...
        {diagrams.length === 0 ? (
          <div className="flex flex-col items-center justify-center rounded-lg border border-border bg-card py-14 text-center shadow-card-sm">
...
function DiagramCard({
  ...
  return (
    <div className="group overflow-hidden rounded-lg border border-border bg-card shadow-card-sm transition-shadow hover:shadow-card-md">
      <button
        type="button"
        onClick={onOpen}
