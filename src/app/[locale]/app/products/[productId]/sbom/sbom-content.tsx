...
export function SbomContent({
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            {SEVERITY_CARDS.map((s, i) => (
              <div
                key={s.key}
                className="relative overflow-hidden rounded-lg border border-border bg-card px-4 py-3 opacity-0 shadow-card-sm"
                style={{
      ...
      {sboms.length === 0 ? (
        <div
          className="flex flex-col items-center justify-center overflow-hidden rounded-lg border border-border bg-card shadow-card-md py-16 text-center"
        >
