...
// Banner is always the wavy blue Nask cover SVG. We tried plumbing in
// per-product `image_url` photos as a fallback but the user pushed
// back: product photos belong in the detail-page header and inside
// list-row avatars, not on the hero banner. Keeping the banner uniform
// across the dashboard hero strip and the products grid means every
// "Project Card" surface in the app reads as one family.
...
export function ProjectHeroCard({
  ...
  return (
    <Link
      ...
      // the corners.
      className="group/hero-card relative flex h-[249px] w-full flex-col overflow-clip rounded-lg border border-border bg-card shadow-card-md transition-shadow hover:shadow-card-lg"
    >
