...
export function GetStartedGuide({ state, firstName }: Props) {
  ...
  return (
    <div className="mx-auto flex w-full max-w-[900px] flex-col gap-6">
      ...
      <div className="flex flex-col gap-2 rounded-lg bg-card p-6 shadow-card-md">
  ...
  const content = (
    <div
      className={cn(
        ...
        "flex items-center gap-4 rounded-lg bg-card px-5 py-4 shadow-card-sm transition-colors",
