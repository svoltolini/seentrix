...
export default async function AdminIssuesPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {issues.length === 0 ? (
        <div className="rounded-lg bg-card p-8 text-center text-p3 text-muted-foreground shadow-card-sm">
...
function IssueRow({ issue }: { issue: SentryIssue }) {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="flex items-start justify-between gap-4 rounded-lg bg-card p-4 shadow-card-sm transition-colors hover:bg-muted/40"
    >
